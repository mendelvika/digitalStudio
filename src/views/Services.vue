<template>
  <div class="services-container">
    <div class="left-side">
      <img :src="image" class="img-container" />
    </div>
    <div class="right-side">
      <div class="service1" :class="{active: showDesc1}">
        <h4>
      ...
      <div class="service2" :class="{active: showDesc2}">
        <h4>
          <b>02</b>marketing
...
export default {
  ...
  data() {
    return {
      image: "../styles/images/9.gif",
      showDesc1: false,
      showDesc2: false,
      showDesc3: false,
      showDesc4: false,
      image1: "../styles/images/9.gif",
      image2: "../styles/images/8.gif",
      image3: "../styles/images/5.gif",
      image4: "../styles/images/6.gif"
    };
  },
  methods: {
    showDescription1() {
